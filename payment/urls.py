...
urlpatterns = [
    ...
    re_path(r'^freekassa-notify\w*', Notify.as_view(), name='freekassa_notify_url'),
    re_path(r'^freekassa-success\w*', FreeKassaSuccess.as_view(), name='freekassa_success_url'),
    re_path(r'^freekassa-fail\w*', Fail.as_view(), name='freekassa_fail_url'),
    ...
    re_path(r'^aaio-notify\w*', Notify.as_view(), name='aaio_notify_url'),
    re_path(r'^aaio-success\w*', FreeKassaSuccess.as_view(), name='aaio_success_url'),
    re_path(r'^aaio-fail\w*', Fail.as_view(), name='aaio_fail_url'),
